...
The marketing hero uses a lightweight inline-SVG celestial globe under
`src/features/rotating-globe-hero`. The globe rotates deterministically and
freezes into a complete static state for reduced motion. Authentication uses a
CSS atmosphere, while banking screens and transactional forms remain free of
decorative 3D.
...
- `src/features/rotating-globe-hero` owns the production marketing hero,
  animated headline, deterministic SVG globe, and reduced-motion behavior.
